...
public final class UserInfoQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("user", arguments: ["login": "kindnesswall"], type: .object(User.selections)),
    ]
        ...
        public struct Edge: GraphQLSelectionSet {
          ...
          public struct Node: GraphQLSelectionSet {
            ...
            public static let selections: [GraphQLSelection] = [
              ...
              GraphQLField("collaborators", arguments: ["first": 10], type: .object(Collaborator.selections)),
            ]
            ...
            public init(name: String, collaborators: Collaborator? = nil) {
              self.init(unsafeResultMap: ["__typename": "Repository", "name": name, "collaborators": collaborators.flatMap { (value: Collaborator) -> ResultMap in value.resultMap }])
            }
            ...
            public struct Collaborator: GraphQLSelectionSet {
              ...
              public init(totalCount: Int, nodes: [Node?]? = nil) {
                self.init(unsafeResultMap: ["__typename": "RepositoryCollaboratorConnection", "totalCount": totalCount, "nodes": nodes.flatMap { (value: [Node?]) -> [ResultMap?] in value.map { (value: Node?) -> ResultMap? in value.flatMap { (value: Node) -> ResultMap in value.resultMap } } }])
              }
