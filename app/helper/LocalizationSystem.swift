...
class LocalizationSystem:NSObject {
    ...
    func setLanguage(languageCode:String) {
        var appleLanguages = UserDefaults.standard.object(forKey: AppConst.AppleLanguages) as! [String]
        appleLanguages.remove(at: 0)
        appleLanguages.insert(languageCode, at: 0)
        UserDefaults.standard.set(appleLanguages, forKey: AppConst.AppleLanguages)
    ...
    func getLanguage() -> String {
        let appleLanguages = UserDefaults.standard.object(forKey: AppConst.AppleLanguages) as! [String]
